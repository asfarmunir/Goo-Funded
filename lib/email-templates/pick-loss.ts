export const getPickLossEmailTemplate = (
  ...
  const PICK_LOSS_TITLE = "Goo Funded - Pick Loss";
...
.moz-text-html .mj-column-per-20 { width:20% !important; max-width: 20%; }
    ...
    <style type="text/css">
    *{ font-family: 'Poppins'; src: url("https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" "); format('truetype'); margin: 0px auto; padding: 0px;}
    </style>
...
<link rel="preconnect" href="https://fonts.googleapis.com">
  ...
  <body style="word-spacing:normal;background-color:#FFFFFF;">
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1747403130/email%20images/GooFunded/Bet_Lost_kwrw9c.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      >Hi ${name},</br></br>
            ...
            This email is to inform you that your picks lost unfortunately.. Don’t worry, the next is around the corner! </br></br>
   The updates balance is showing on your dashboard.</div>
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1747402897/email%20images/GooFunded/Login_to_dash_kok6ff.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="180"
      />
