export const getPhaseCompleteEmailTemplate = (name: string, phase: number, accountNumber: string) => {
    const PHASE_COMPLETE_TITLE = "Welcome to the Vantage Picks!";
...
<link rel="preconnect" href="https://fonts.googleapis.com">
  ...
  <body style="word-spacing:normal;background-color:#FFFFFF;">
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1747397091/email%20images/GooFunded/passed_phase_1_zwgxlu.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <div
         style="font-family:Poppins;font-size:16px;font-weight:600;line-height:24px;text-align:center;color:#001E45;"
      >Your account ${accountNumber} </br>
has passed the<span style="color:#2160EB"> Phase 1 objectives.</span></div>
...
<link rel="preconnect" href="https://fonts.googleapis.com">
  ...
  <body style="word-spacing:normal;background-color:#FFFFFF;">
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1747399023/email%20images/GooFunded/passed_phase_2_odkgi4.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <div
         style="font-family:Poppins;font-size:16px;font-weight:600;line-height:24px;text-align:center;color:#001E45;"
      >Your account ${accountNumber} </br>
has passed the<span style="color:#2160EB"> Phase 2 objectives.</span></div>
