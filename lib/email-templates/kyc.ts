...
.moz-text-html .mj-column-per-20 { width:20% !important; max-width: 20%; }
  ...
  <body style="word-spacing:normal;background-color:#ffffff;">
      ...
      <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><v:rect style="width:600px;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"><v:fill origin="0, -0.5" position="0, -0.5" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1731614703/Vantage/Html%20Email%20Images/hero%20image/KYC_Approved_yppryq.png" type="frame" size="1,1" aspect="atmost" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0"><![endif]-->
       ...
       <div  style="background:url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1747401535/email%20images/GooFunded/KYC_Approved_lttbhd.png') center top / contain no-repeat;background-position:center top;background-repeat:no-repeat;background-size:contain;margin:0px auto;max-width:600px;">
