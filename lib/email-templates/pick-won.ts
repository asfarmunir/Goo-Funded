export const getPickWonEmailTemplate = (
  ...
  const PICK_WON_TITLE = "Goo Funded - Pick Won";
...
<link rel="preconnect" href="https://fonts.googleapis.com">
  ...
  <body style="word-spacing:normal;background-color:#FFFFFF;">
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1747402996/email%20images/GooFunded/Bet_Won_v24nzh.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      >Hi ${name},</br></br>
            ...
            This email is to inform you that your picks worked out perfectly, amazing job! </br></br>
